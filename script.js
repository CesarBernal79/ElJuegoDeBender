...
const palabras = ['Estonia', 'Turquia', 'Vietnam', 'Suecia', 'Armenia', 'Serbia', 'Camerun', 'Congo', 'Malta', 'Haiti', 'Kuwait', 'Alaska', 'Catar', 'Egipto', 'Escocia', 'Angola', 'Andorra',  'Chipre', 'Etiopia', 'Uganda', 'Uruguay', 'Serbia', 'Bahamas', 'Birmania', 'Siria', 'Nepal', 'Libano', 'Yemen', 'Angola', 'Ghana', 'Kenia', 'Ruanda', 'Somalia', 'Tunez', 'Sudafrica'];
const btn = id('jugar');
